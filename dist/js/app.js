...
function controllerRouter() {
	...
	if (currentRoute === 'technology') {
		_jquery2.default.getJSON('https://api.nytimes.com/svc/topstories/v1/technology.json?api-key=12e8922b74134ddabb5c1f2c5e866001').then(function (serverRes) {
	...
	if (currentRoute === 'sports') {
		_jquery2.default.getJSON('https://api.nytimes.com/svc/topstories/v1/sports.json?api-key=12e8922b74134ddabb5c1f2c5e866001').then(function (serverRes) {
	...
	_jquery2.default.getJSON('https://api.nytimes.com/svc/topstories/v1/world.json?api-key=12e8922b74134ddabb5c1f2c5e866001').then(function (serverRes) {
...
function createArticlePageTemplate(dataArray, title) {
	...
	forEach(dataArray, function (articleObj) {
		var imgLink = '';
		if (_typeof(articleObj.multimedia) === 'object') {
